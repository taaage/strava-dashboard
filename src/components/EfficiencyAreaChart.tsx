  ...
  return (
    <div className="bg-surface-card rounded-3xl p-8 border border-surface-border">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-lg font-semibold text-text-primary mb-1">Efficiency Over Time</h2>
          <p className="text-sm text-text-muted">Watts per heartbeat — higher = fitter</p>
        </div>
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={rides}>
            ...
            <Area
              ...
              dot={rides.length < 30 ? { r: 3, fill: "hsl(160, 60%, 45%)" } : false}
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
