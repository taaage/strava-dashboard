...
const POWER_COLORS = ["hsl(210, 50%, 70%)", "hsl(210, 70%, 55%)", "hsl(160, 60%, 45%)", "hsl(45, 80%, 55%)", "hsl(25, 80%, 55%)", "hsl(0, 70%, 55%)", "hsl(280, 65%, 55%)"];
const HR_COLORS = ["hsl(210, 50%, 70%)", "hsl(210, 70%, 55%)", "hsl(160, 60%, 45%)", "hsl(25, 80%, 55%)", "hsl(0, 70%, 55%)"];
...
function ZoneBar({ data, colors, height }: { data: { name: string; hours: number; percentage: number }[]; colors: string[]; height: string }) {
  return (
